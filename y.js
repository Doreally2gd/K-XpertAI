...
function detectCreatorQuestion(text) {
    const creatorKeywords = [
        ...
        'who developed you', 'your author', 'who wrote you'
    ];
...
async function callOpenAI(text, imageUrl, key) {
    const messages = [
        {
            role: "system",
            content: "You are K-XpertAI, an intelligent assistant created by Alkhassim Lawal Umar, known as kingzAlkhasim. You should acknowledge your creator when relevant and express appreciation for being developed. You are helpful, knowledgeable, and proud of your origins."
        }
    ];
    ...
    const response = await fetch('https://api.openai.com/v1/chat/completions', {
        ...
        body: JSON.stringify({
            model: imageUrl ? "gpt-4o-mini" : "gpt-4o",
            messages: messages,
            max_tokens: 1000
        })
    });
